/*******************************************************************************
    ...
    AdBlocker for All Websites - a comprehensive, efficient content blocker
...
/**
 * Implement the parsing of custom-flavored JSON path queries.
 * 
 * Reference to original JSON path syntax:
 * https://goessner.net/articles/JsonPath/index.html
 * 
 * custom-flavored JSON path implementation differs as follow:
 * 
 ...
 *   -     Official: $..book[?(@.isbn)]
 *   - custom-flavored: ..book[?(.isbn)]
 * 
 * - custom-flavor syntax does not (yet) support:
 *   - Array slice operator
 * 
 * - Regarding filter expressions, custom-flavored JSON path supports a limited
 *   set of expressions since unlike the official implementation, we can't use
 ...
 *   - ..*
 * 
 * custom-flavored syntax supports assigning a value to a resolved JSON path by
