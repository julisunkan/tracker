/*******************************************************************************
    ...
    Copyright (C) 2014-present AdBlock All Team
    ...
    Home: https://github.com/ABlockAll/adblock
*/

// Important!
// Isolate from global scope
(function adblock_cssProceduralAPI() {
...
class PSelectorMatchesMediaTask extends PSelectorTask {
    ...
    handler() {
        ...
        this.filterer.adblock_DOMChanged();
    }
}
...
class ProceduralFilterer {
    ...
    adblock_commit() {
        ...
        // https://github.com/AdBlockAll/issues/issues/341
        ...
        for ( const pselector of this.selectors.values() ) {
            ...
            if ( pselector.budget < -500 ) {
                console.info('AdBlockAll: disabling %s', pselector.raw);
...
self.ProceduralFiltererAPI = class {
    ...
    addSelectors(selectors) {
        ...
        this.proceduralFilterer.adblock_commit();
    }
    ...
    onDOMChanged(mutations) {
        for ( const mutation of mutations ) {
            for ( const added of mutation.addedNodes ) {
                ...
                return this.proceduralFilterer.adblock_DOMChanged();
            }
