...
export class AstFilterParser {
    constructor(options = {}) {
        ...
        this.punycoder = new URL('https://adblockall.invalid/');
...
// Ref: issue #2624
//   Convert Adguard's `-ext-has='...'` into our `:has(...)`.
...
export class ExtSelectorCompiler {
    ...
    compile(raw, out, compileOptions = {}) {
        ...
        //   filter.
        // Adguard/EasyList style injection: translate to our format.
